...
print("# get record available")
url = "http://localhost:8080/v2/record/available"
response = requests.get(url)
if response.status_code == 200:
    json_data = response.json()
    want = {
            "fy": ["2000"],
            "yyyymm": ["200007", "200006", "200005", "200004"],
    }
...
print("# get records (4)")
url = "http://localhost:8080/v2/record?yyyymm=200007"
response = requests.get(url)
if response.status_code == 200:
    json_data = response.json()
    want = [
...
print("# get records (5)")
url = "http://localhost:8080/v2/record?category_id=300"
response = requests.get(url)
if response.status_code == 200:
    json_data = response.json()
    want = [
...
print("# get records (6)")
url = "http://localhost:8080/v2/record?category_id=300&yyyymm=200005&num=999"
response = requests.get(url)
if response.status_code == 200:
    json_data = response.json()
    want = [
